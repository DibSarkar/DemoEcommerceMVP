...
public class ImagePicker {
    ...
    private static String TEMP_IMAGE_NAME = "tempPic.png";
    private static String PICK_DESC= "Pick your image";
    public static int minWidthQuality = DEFAULT_MIN_WIDTH_QUALITY;



    public static void setImageName(){


            TEMP_IMAGE_NAME = "profilePic.png";
            PICK_DESC= "Pick your image";
    ...
    public static File getSavedFile(Context context, int resultCode,
                                    Intent imageReturnedIntent) {
        Log.d(TAG, "getImageFromResult, resultCode: " + resultCode);
        Bitmap bm = null;
        File imageFile = getTempFile(context);
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            if (isCamera) {     /** CAMERA **/
               //selectedImage = Uri.fromFile(imageFile);
                ...
                Uri tempUri = imageReturnedIntent.getData();
