...
public class NumberPicker extends LinearLayout {
    ...
    private void initialize(Context context, AttributeSet attrs) {
        ...
        this.displayEditText = (TextView) findViewById(R.id.display);
        this.addButton = (Button)findViewById(R.id.add);
        try {


            this.bt_add = (Button) findViewById(R.id.bt_add);
            this.bt_add.setOnClickListener(new ActionListener(this, this.displayEditText, ActionEnum.INCREMENT));
        ...
        this.addButton.setOnClickListener(new ActionListener(this, this.displayEditText, ActionEnum.INCREMENT));
    ...
    public void refresh() {
        if(currentValue<=minValue){
            ...
            try {
                ...
                this.bt_add.setVisibility(View.VISIBLE);
            }
            catch (Exception e)
            {
                e.printStackTrace();
            ...
            try {
                ...
                this.bt_add.setVisibility(View.GONE);
            }
            catch (Exception e)
            {
                e.printStackTrace();
